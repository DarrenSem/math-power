...
module.exports = (test) => {
  ...
  test.it("Returns correct numeric answer if provided [partial] URL whose querystring contains both numbers with valid operator", (assert, _) => {
    ...
    assert(_ === 12, `Expected calcqs("https://example.com/api?num1=3.x&num2=4&operator=times") to be |12|, got |${_}|`);
    ...
    assert(_ === 12, `Expected calcqs("?num1=3.x&num2=4&operator=times") to be |12|, got |${_}|`);
    ...
    assert(_ === 81, `Expected calcqs("https://example.com/testing-api?num1=3.x&num2=4&operator=to+the+power+of") to be |81|, got |${_}|`);
    ...
    assert(_ === 27, `Expected calcqs("https://example.com/testing-api?num1=3.x&num2=3&operator=to+the%20power%20of") to be |27|, got |${_}|`);
